...
<div class="row">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <form action="{{route('petnames.update',$petnames->id)}}" method="post" >
        {{csrf_field()}}
       ...
       <div class="form-group">
         ...
         <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="Name" class="form-control col-md-12 col-xs-12" name="name" placeholder="Change role description" required="required" type="text" value="{{old('name',$petnames->name)}}">
