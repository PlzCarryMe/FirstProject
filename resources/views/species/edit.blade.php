...
<div class="row">
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
     ...
     <div class="actionbutton">
        ...
        <a class='btn btn-info float-right' href="{{route('species')}}">List</a>
    ...
    <form action="{{route('species.update',$species->id)}}" method="post" >
       ...
       <div class="form-group">
         ...
         <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="Name" class="form-control col-md-12 col-xs-12" name="name" placeholder="Change role description" required="required" type="text" value="{{old('name',$species->name)}}">
