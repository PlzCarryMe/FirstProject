                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('subjects') }}">{{ __('User') }}</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('species') }}">{{ __('Species') }}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('petnames') }}">{{ __('Pet Names') }}</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('pets') }}">{{ __('Pets') }}</a>
                            </li>
